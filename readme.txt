=== WordPress Reviews Widgets for Google, Yelp, and TripAdvisor Reviews ===
Tags: reviews, reviews widgets, widgets, google reviews, yelp reviews
...
= 1.1.0 = 9 Dec 2021
* Google Reviews are now much easier to retrieve: you just choose the Google Place from an autocomplete list - no API keys or place IDs required, and you get instant results.
